              ...
              >
                ...
                <div className="mb-8">
                  <textarea
                    placeholder="Message"
                    rows={4}
                    className="w-full border-b border-gray-300 bg-transparent pb-3.5 text-gray-800 placeholder-gray-500 focus:border-indigo-500 focus:placeholder-gray-900 focus-visible:outline-none dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 dark:focus:border-indigo-400 dark:focus:placeholder-gray-400"
                  ></textarea>
                </div>
                ...
                <div className="flex flex-wrap gap-4 xl:justify-between">
                  <div className="flex items-center">
                    ...
                    />
                    <span className="flex h-5 w-5 items-center justify-center rounded border border-gray-300 bg-gray-100 text-indigo-600 dark:border-gray-600 dark:bg-gray-700 peer-checked:bg-indigo-600">
                      <svg
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2.5 rounded-full bg-indigo-600 px-6 py-3 text-white font-medium transition-all duration-300 ease-in-out hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600"
                  >
                    Send Message
                    <svg
