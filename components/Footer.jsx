      ...
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="py-10 lg:py-20">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                <p className="mb-6 mt-5 text-xl font-semibold text-gray-700 dark:text-gray-300">
                ...
                <a
                  ...
                  className="text-itemtitle font-medium text-gray-700 dark:text-white hover:text-indigo-500"
                >
                  nammapg@gmail.com
                </a>
              </motion.div>
              ...
              <div className="flex w-full gap-8 flex-row md:justify-between md:gap-4 lg:w-2/3 xl:w-7/12">
                  ...
                  <ul>
                    {["Home", "Product", "Careers", "Pricing"].map((link) => (
                      <li key={link}>
                        <a
                          href="#"
                          className="mb-3 inline-block font-semibold text-gray-700 hover:text-indigo-500 dark:text-gray-300"
                        >
                          {link}
                        </a>
                      </li>
                ...
                >
                  ...
                  <p className="mb-4 w-[90%] font-semibold text-sm text-gray-600 dark:text-gray-300">
          ...
          <div className="flex flex-col items-center justify-center gap-5 border-t border-stroke py-5 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <a href="#" className="hover:text-indigo-500">
                <Facebook className="bg-gray-100 rounded-full p-2 size-8 text-slate-600 hover:text-white hover:fill-black dark:text-gray-300" />
              </a>
              <a href="#" className="hover:text-indigo-500">
                <Twitter className="bg-gray-100 rounded-full p-2 size-8 text-slate-600 hover:text-white hover:fill-black dark:text-gray-300" />
              </a>
              <a href="#" className="hover:text-indigo-500">
                <Instagram className="bg-gray-100 rounded-full p-2 size-8 text-slate-600 hover:text-white hover:fill-black dark:text-gray-300" />
              </a>
            </motion.div>
          </div>
